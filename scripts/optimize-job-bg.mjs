/**
 * 招聘顶图：从 src/images/job-bg.png 生成 WebP，供 <picture> 优先加载。
 * 运行: node scripts/optimize-job-bg.mjs
 */
...
const srcPng = join(root, 'src/images/job-bg.png')
const outWebp = join(root, 'src/images/job-bg.webp')
...
await report('job-bg.png (源文件)', orig)
...
await report('job-bg.webp', webpBuf)
