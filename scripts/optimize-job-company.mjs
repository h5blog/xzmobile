/**
 * 加入我们页办公环境 job-company1/2：稿 660×495，1×/2× WebP + PNG（2×）回退。
 * object-cover 与页面一致，缩放使用 cover。
 * 运行: node scripts/optimize-job-company.mjs
 */
...
const SPECS = [{ name: 'job-company1' }, { name: 'job-company2' }]
