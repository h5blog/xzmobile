/**
 * 新闻中心顶图：从 src/images/news-bg.png 生成 WebP，供 <picture> 优先加载。
 * 运行: node scripts/optimize-news-bg.mjs
 */
...
const srcPng = join(root, 'src/images/news-bg.png')
const outWebp = join(root, 'src/images/news-bg.webp')
...
await report('news-bg.png (源文件)', orig)
...
await report('news-bg.webp', webpBuf)
