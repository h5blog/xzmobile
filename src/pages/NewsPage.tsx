...
const newsItems = [
  {
    title: '全球各国核聚变战略部署',
    date: '2026-01-01',
    desc: '美国能源部（DOE）为核聚变创新研究引擎（FIRE）合作组织提供 1.07 亿美元，用于支持聚变能源科学、技术、工程与商业化协同创新。',
  },
  {
    title: '中国核聚变相关政策时间线表格年份',
    date: '2026-01-01',
    desc: '《加快电力装备绿色低碳创新发展行动计划的通知》加快三代核电标准化、谱系化发展，持续推进钠冷快堆、高温气冷堆、铅铋快堆等四代核电堆型的研发和应用。加快可控核聚变等前沿颠覆性技术研究。',
  },
  {
    title: '8月27日：《关于推进 “人工智能 +” 能源高质量发展的实施意见》',
    date: '2026-01-01',
    desc: '国家发展改革委、国家能源局《关于推进“人工智能 +”能源高质量发展的实施意见》',
  },
  {
    title: 'AI 赋能聚变已成全球共识',
    date: '2026-01-01',
